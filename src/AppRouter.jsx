...
function AppRouter({ telegramId, role, profileLink, apiUrl, isFetchReady, setRole }) {
    ...
    return (
        <Routes>
            ...
            <Route path="/change-role" element={<RoleSelectionPage onRoleChange={handleRoleChange} role={role}/>} />
            <Route path="/archive" element={<ArchivePage apiUrl={apiUrl} telegramId={telegramId} role={role} />} />
            ...
            <Route path="/generate-image" element={<GenerateImagePage apiUrl={apiUrl} telegramId={telegramId} />} />
        </Routes>
    );
}
